        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6 col-12 offset-lg-3 d-none" id="changePassword">
                <div class="card p-5">
                    ...
                    <center>
                        <span>© 2022 All Rights Reserved. ProjectX</span>
                    </center>
                </div>
            </div>
...
<script>
    ...
    $(document).on("click", "#forgotPassword", function (e) {
        ...
        $.ajax({
            url: "{{ URL::to('api/user/forgot-password') }}",
            type: 'POST',
            dataType: "json",
            processData: false,
            contentType: false,
    ...
    $(document).on("click", "#sendOtp-button", function (e) {
        ...
        $.ajax({
            url: "{{ URL::to('api/user/user-verify') }}",
            type: 'POST',
            dataType: "json",
            processData: false,
            contentType: false,
    ...
    $(document).on("click", "#resend", function (e) {
        ...
        console.log(email);
        $.ajax({
            url: "{{ URL::to('api/user/resend-code') }}",
            type: 'POST',
            dataType: "json",
            data: {
                "email" : email,
    ...
    $(document).on("click", "#recoverPass", function (e) {
        ...
        $.ajax({
            url: "{{ URL::to('api/user/change-password') }}",
            type: 'POST',
            dataType: "json",
            processData: false,
            contentType: false,
