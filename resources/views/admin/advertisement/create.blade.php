...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <form id="mobileAdForm" method="POST" enctype="multipart/form-data"
              action="{{ URL::to('api/advertisement/store') }}">
            @csrf
                                ...
                                <div class="add-content">
                                    <div class="ad-title">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                {{--                                                <input class="form-check-input" name="status[google]" type="checkbox"--}}
                                    ...
                                    <div class="ad-body">
                                        ...
                                        <div class="native-details">
                                            <div class="form-group">
                                                <label for="googlNativeAddPerVideo">Native Ad Per Blog</label>
                                                <input type="number" name="native_per_blog[google]"
                                                       value="{!! $data->native_per_blog ?? '' !!}" class="form-control create-form"
                        ...
                        <div class="add-content">
                            ...
                            <div class="ad-body">
                                ...
                                <div class="native-details">
                                    <div class="form-group">
                                        <label for="googlNativeAddPerVideo">Native Ad Per Blog </label>
                                        <input type="number" name="native_per_blog[google]" class="form-control create-form"
                                               id="googlNativeAddPerVideo">
                                    </div>
                                    {{-- <div class="form-group">
                                        <label for="googlNativeAddPerVideoSeries">Native Ad Per Video (For
                            ...
                            <div class="col-md-6 fb-ad">
                                <div class="add-content">
                                    ...
                                    <div class="ad-body">
                                        ...
                                        <div class="native-details">
                                            <div class="form-group">
                                                <label for="facebookNativeAddPerVideo">Native Ad Per Blog</label>
                                                <input type="number" name="native_per_blog[facebook]"
                                                       value="{!! $data->native_per_blog ?? '' !!}" class="form-control create-form"
                                    ...
                                    <div class="ad-body">
                                        <div class="row">
                                            <div class="col-md-6 custom-banner">
                                                <div class="form-group">
                                                    <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->banner_image }}" alt="" height="80" width="100"><br>
                                            ...
                                            <div class="col-md-6 custom-interseticial">
                                                <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->interesticial_image }}" alt="" height="80" width="100"><br>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 native-interseticial">
                                                <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->native_image }}" alt="" height="80" width="100"><br>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="customNativeAddPerVideo">Native Ad Per Blog </label>
                                                    <input type="number" name="native_per_blog[custom]"
                                                           value="{!! $data->native_per_blog ?? '' !!}" class="form-control create-form"
